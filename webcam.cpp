...
//  imshow("black", black);
  ...
  Mat fgd, bgd;
  grabCut(image, black, NULL, bgd, fgd, 5, GC_INIT_WITH_MASK);
  imshow("bgd1", bgd);
  imshow("fgd1", fgd);
  grabCut(image, black, NULL, bgd, fgd, 15, GC_INIT_WITH_MASK);
  imshow("bgd2", bgd);
  imshow("fgd2", fgd);
  grabCut(image, black, NULL, bgd, fgd, 25, GC_INIT_WITH_MASK);
  imshow("bgd3", bgd);
  imshow("fgd3", fgd);
